...
{
  // talau: disable PacketMetadata operations due bug with TcpRfc793
  // http://groups.google.com/group/ns-3-users/browse_thread/thread/cba6f387ed3e3b4f?fwc=1
  return;
